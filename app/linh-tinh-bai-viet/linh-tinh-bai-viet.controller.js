(function() {
    'use strict';    
    angular.module("app.any-post").controller("AnyPostController",AnyPostController)
    function AnyPostController($scope,$http,$state,ENV){
        ...
        $http.post(ENV.API_URL + "/post/getlenpagination", {"category" : "BÊN LỀ"}).then(result =>{               
